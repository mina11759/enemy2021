...
def word_preprocess_dataset(dataset_name):
    ...
    for item in tqdm(data):
        if item['owner'] == 'nobody@mozilla.org':
            ...
            owner = item['owner']
            clean_data = clean_word_list(item)
    ...
    return all_assignee, all_description, max_word_num
...
def desc_word_embedding(desc, max_word_num):
    """
    ...
    for words in tqdm(desc): # words are tokenizing
        one_desc_word_list = []
